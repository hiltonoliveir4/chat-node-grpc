  ...
  rl.question("", (command) => {
    ...
    if (command !== "") {
      if (mensagem[0] == "/help") {
        ...
        if (usuario == "") {
          console.log(
            "Você precisa se cadastrar e logar para entrar em salas!"
          );
        } else {
          client.Joinroom(
            {
        ...
        if (usuario == "") {
          console.log(
            "Você precisa se cadastrar ou logar para kickar usuários!"
          );
        } else {
          client.Kick(
            {
        ...
        if (usuario == "") {
          console.log(
            "Você precisa se cadastrar ou logar para banir usuários!"
          );
        } else {
          client.Ban(
            {
